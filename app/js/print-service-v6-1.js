import { esc, fmtMoney, fmtNumber } from "./ui.js";
...
function bakeryStructuredBlocks(db, item, itemLines = [], { includeCost = false, includeAllergens = false } = {}) {
  ...
  return [
    ...
    bakeryBlockTable("Acabados / terminación", finishingRows, { includeCost, includeAllergens, empty: "Sin acabados ni terminaciones registrados." })
  ].join("");
}
